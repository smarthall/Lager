...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProcessedBlob', fields ['hashtype', 'hash']
        db.create_unique('blobstore_processedblob', ['hashtype', 'hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProcessedBlob', fields ['hashtype', 'hash']
        db.delete_unique('blobstore_processedblob', ['hashtype', 'hash'])
