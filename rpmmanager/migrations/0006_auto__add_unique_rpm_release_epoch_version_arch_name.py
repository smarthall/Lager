...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RPM', fields ['release', 'epoch', 'version', 'arch', 'name']
        db.create_unique('rpmmanager_rpm', ['release', 'epoch', 'version', 'arch', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'RPM', fields ['release', 'epoch', 'version', 'arch', 'name']
        db.delete_unique('rpmmanager_rpm', ['release', 'epoch', 'version', 'arch', 'name'])
